...
Cochrane Reviews 2 (протоколы исследований эффективности при гепатите B, результатов пока нет); FDA 0; RXlist 0; ВОЗ 0; ФК (Не рекомендован к медицинскому применению, применялся для лечения заболеваний сердца).
